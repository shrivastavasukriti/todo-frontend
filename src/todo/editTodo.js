...
import { UpdateTodo } from './actions/getTodoActions'
...
class editTodo extends React.Component {
    ...
    updateTodos = (e) => {
        ...
        console.log(this.todo, 'sdsdsdsdsdsd')
        this.todo.desc= "Eishta Changed this";
        this.props.updateTodo(this.todo).then(()=> {
                ...
                <div class="card w-75 text-left" >
                    ...
                    <form style={{ margin: '5%' }} >
                        ...
                        <div style={{ display: 'flex' }}>
                            <button type="submit" class="btn mr-2" onClick={this.updateTodos} >Edit Todo</button>
...
const mapStateToProps =( state, ownProps)=> {
    ...
    let a = state.todos.find(todo=> todo._id === ownProps.match.params.id)
    // console.log(state.todos)
    // console.log('ssdsdsdsdsdsdsdsdsds0', a)
    return {
        todos:a
    }
}
